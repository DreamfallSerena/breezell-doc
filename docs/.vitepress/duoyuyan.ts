...
const yuyanwenben: Record<string, yuyanwenben> = {
  root: {
    ...
    tishicishezhi: "Prompt & Skill Settings",
  ...
  es: {
    ...
    tishicishezhi: "Configuración de instrucciones y habilidades",
  ...
  "pt-br": {
    ...
    tishicishezhi: "Configurações de prompt e habilidades",
  ...
  ru: {
    ...
    tishicishezhi: "Настройки промптов и навыков",
